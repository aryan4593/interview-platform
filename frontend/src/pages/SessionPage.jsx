...
function SessionPage() {
  ...
  const { call, channel, chatClient, isInitializingCall, streamClient } =
    useStreamClient(session, sessionLoading, isHost, isParticipant);
  ...
  // auto join participant if user is not participant and not host
  useEffect(() => {
    if (!session || sessionLoading || !user) return;
      ...
      <PanelGroup direction="horizontal">
        ...
        <Panel defaultSize={50} minSize={30}>
          ...
          <div className="h-full bg-base-200 p-4 overflow-auto">
            {isInitializingCall ? (<div className="h-full flex items-center justify-center">
